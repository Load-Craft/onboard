...
When writing the project description for LoadCraft — skills/loadcraft-overview/SKILL.md.
EOF
```
...
skills/loadcraft-journeys/SKILL.md, skills/loadcraft-asyncapi/SKILL.md
and skills/loadcraft-overview/SKILL.md.
EOF
```
